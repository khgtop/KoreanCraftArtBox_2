...
import kotlinx.android.synthetic.main.fragment_content321.*
...
class Content321Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoImageViews = listOf(videoImageView1, videoImageView2, videoImageView3)
        val videoResources = listOf(R.raw.video20, R.raw.video21, R.raw.video22)
        ...
        for (i in videoImageViews.indices) {
            ...
            videoImageViews[i].setOnClickListener {
                ...
                startActivityForResult(intent, Content321Fragment.VIDEO_ACTIVITY_REQUEST_CODE)
            }
        }
    }
