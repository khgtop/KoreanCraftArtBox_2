...
import kotlinx.android.synthetic.main.fragment_content221.videoImageView1
import kotlinx.android.synthetic.main.fragment_content221.rightButton
import kotlinx.android.synthetic.main.fragment_content221.view.myScrollView

class Content221Fragment : Fragment() {
    companion object {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_content221, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoResources = listOf(R.raw.video13)
        ...
        for (i in videoImageViews.indices) {
            ...
            videoImageViews[i].setOnClickListener {
                ...
                startActivityForResult(intent, Content221Fragment.VIDEO_ACTIVITY_REQUEST_CODE)
            }
        }
    }
    ...
    private fun replaceWithSecondFragment() {
        requireActivity().supportFragmentManager.beginTransaction()
            .replace(R.id.detail_content_frame2, Content222Fragment())
            .addToBackStack(null)
            .commit()
    }
}