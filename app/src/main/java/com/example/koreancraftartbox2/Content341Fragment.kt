...
import kotlinx.android.synthetic.main.fragment_content341.rightButton
import kotlinx.android.synthetic.main.fragment_content341.view.myScrollView


class Content341Fragment : Fragment() {
    companion object {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_content341, container, false)
    ...
    private fun replaceWithSecondFragment() {
        requireActivity().supportFragmentManager.beginTransaction()
            .replace(R.id.detail_content_frame3, Content342Fragment())
            .addToBackStack(null)
            .commit()
    }
}